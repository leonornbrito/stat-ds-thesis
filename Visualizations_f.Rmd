...
setwd("/Users/leonorbrito/Documents/Master/Thesis/Datasets/Visuals")
area_prod <- read.csv('prod_area.csv')
...
yield_prod <- read.csv('yield_prod.csv')
...
temp <- read.csv('temp_change_summer.csv') 
```
